...
do 
	...
	awk -v threads_lectura=$cantidad_de_threads -v threads_maximo=$cantidad_de_threads -v salida=$maximo '{print threads_lectura","threads_maximo","$1","salida}' temp.txt &>> output/experimento2/lectura_sin_concurrencia/salida-threads-lectura.csv 
